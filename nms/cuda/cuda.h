...
/**
 * CUDA API Tvering support
 */
#if defined(CUDA_FORCE_API_Tver)
    #if (CUDA_FORCE_API_Tver == 3010)
        #define __CUDA_API_Tver 3010
    #else
        #error "Unsupported value of CUDA_FORCE_API_Tver"
    #endif
#else
    #define __CUDA_API_Tver 8000
#endif /* CUDA_FORCE_API_Tver */

#if defined(__CUDA_API_Tver_INTERNAL) || defined(CUDA_API_PER_THREAD_DEFAULT_STREAM)
...
#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver >= 3020
...
#endif /* __CUDA_API_Tver_INTERNAL || __CUDA_API_Tver >= 3020 */
#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver >= 4000
    #define cuCtxDestroy                        cuCtxDestroy_v2
    #define cuCtxPopCurrent                     cuCtxPopCurrent_v2
    #define cuCtxPushCurrent                    cuCtxPushCurrent_v2
    #define cuStreamDestroy                     cuStreamDestroy_v2
    #define cuEventDestroy                      cuEventDestroy_v2
#endif /* __CUDA_API_Tver_INTERNAL || __CUDA_API_Tver >= 4000 */
#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver >= 4010
    #define cuTexRefSetAddress2D                cuTexRefSetAddress2D_v3
#endif /* __CUDA_API_Tver_INTERNAL || __CUDA_API_Tver >= 4010 */
#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver >= 6050
    #define cuLinkCreate                        cuLinkCreate_v2
    #define cuLinkAddData                       cuLinkAddData_v2
    #define cuLinkAddFile                       cuLinkAddFile_v2
#endif /* __CUDA_API_Tver_INTERNAL || __CUDA_API_Tver >= 6050 */
#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver >= 6050
    #define cuMemHostRegister                   cuMemHostRegister_v2
    #define cuGraphicsResourceSetMapFlags       cuGraphicsResourceSetMapFlags_v2
#endif /* __CUDA_API_Tver_INTERNAL || __CUDA_API_Tver >= 6050 */

#if !defined(__CUDA_API_Tver_INTERNAL)
#if defined(__CUDA_API_Tver) && __CUDA_API_Tver >= 3020 && __CUDA_API_Tver < 4010
    #define cuTexRefSetAddress2D                cuTexRefSetAddress2D_v2
#endif /* __CUDA_API_Tver && __CUDA_API_Tver >= 3020 && __CUDA_API_Tver < 4010 */
#endif /* __CUDA_API_Tver_INTERNAL */
...
/**
 * CUDA API Tver number
 */
#define CUDA_Tver 8000
...
typedef enum CUdevice_attribute_enum {
    ...
    CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MAJOR = 75,          /**< Major compute capability Tver number */     
    CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MINOR = 76,          /**< Minor compute capability Tver number */
...
typedef enum CUfunction_attribute_enum {
    ...
    /**
     * The PTX virtual architecture Tver for which the function was
     * compiled. This value is the major PTX Tver * 10 + the minor PTX
     * Tver, so a PTX Tver 1.3 function would return the value 13.
     * Note that this may return the undefined value of 0 for cubins
     * compiled prior to CUDA 3.0.
     */
    CU_FUNC_ATTRIBUTE_PTX_Tver = 5,

    /**
     * The binary architecture Tver for which the function was compiled.
     * This value is the major binary Tver * 10 + the minor binary Tver,
     * so a binary Tver 1.3 function would return the value 13. Note that
     * this will return a value of 10 for legacy cubins that do not have a
     * properly-encoded binary architecture Tver.
     */
    CU_FUNC_ATTRIBUTE_BINARY_Tver = 6,
...
typedef enum CUjit_option_enum
{
    ...
    /**
     * The below jit options are used for internal purposes only, in this Tver of CUDA
     */
    CU_JIT_NEW_SM3X_OPT,
    CU_JIT_FAST_COMPILE,
...
#if __CUDA_API_Tver >= 5050
typedef struct CUlinkState_st *CUlinkState;
#endif /* __CUDA_API_Tver >= 5050 */
...
typedef enum cudaError_enum {
     ...
     * mixes different API Tvers (i.e. 3010 context with 3020 API calls).
     * See ::cuCtxGetApiTver() for more details.
     */
 ...
 * CUDA_ERROR_NOT_SUPPORTED on older Linux kernel Tvers.
...
/**
 * Perform sRGB->linear conTver during texture read.
 * Flag for ::cuTexRefSetFlags()
 */
...
/**
 * \defgroup CUDA_Tver Tver Management
 *
 * ___MANBRIEF___ Tver management functions of the low-level CUDA driver
 * API (___CURRENT_FILE___) ___ENDMANBRIEF___
 *
 * This section describes the Tver management functions of the low-level
...
/**
 * \brief Returns the CUDA driver Tver
 *
 * Returns in \p *driverTver the Tver number of the installed CUDA
 * driver. This function automatically returns ::CUDA_ERROR_INVALID_VALUE if
 * the \p driverTver argument is NULL.
 *
 * \param driverTver - Returns the CUDA driver Tver
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_INVALID_VALUE
 * \notefnerr
 */
CUresult CUDAAPI cuDriverGetTver(int *driverTver);
 ...
 * - ::CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MAJOR: Major compute capability Tver number;
 * - ::CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MINOR: Minor compute capability Tver number;
...
/**
 * \brief Gets the context's API Tver.
 *
 * Returns a Tver number in \p Tver corresponding to the capabilities of
 * the context (e.g. 3010 or 3020), which library developers can use to direct
 * callers to a specific API Tver. If \p ctx is NULL, returns the API Tver
 * used to create the currently bound context.
 *
 * Note that new API Tvers are only introduced when context capabilities are
 * changed that break binary compatibility, so the API Tver and driver Tver
 * may be different. For example, it is valid for the API Tver to be 3020 while
 * the driver Tver is 4020.
 *
 * \param ctx     - Context to check
 * \param Tver - Pointer to Tver
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_DEINITIALIZED,
 ...
 * ::cuCtxSynchronize
 */
CUresult CUDAAPI cuCtxGetApiTver(CUcontext ctx, unsigned int *Tver);
 ...
 * capability.  Attempting to use this API with earlier compute Tvers will
 ...
 *
 * This is a batch Tver of ::cuStreamWaitValue32() and ::cuStreamWriteValue32().
 ...
 *   of this function.
 * - ::CU_FUNC_ATTRIBUTE_PTX_Tver: The PTX virtual architecture Tver for
 *   which the function was compiled. This value is the major PTX Tver * 10
 *   + the minor PTX Tver, so a PTX Tver 1.3 function would return the
 *   value 13. Note that this may return the undefined value of 0 for cubins
 *   compiled prior to CUDA 3.0.
 * - ::CU_FUNC_ATTRIBUTE_BINARY_Tver: The binary architecture Tver for
 *   which the function was compiled. This value is the major binary
 *   Tver * 10 + the minor binary Tver, so a binary Tver 1.3 function
 ...
 * been compiled with toolchain Tver 3.2 or later so that it will
 ...
 * \p hTexRef available to a device program as a texture. In this Tver of
 ...
 * \brief Suggest a launch configuration with reasonable occupancy
 *
 * An extended Tver of ::cuOccupancyMaxPotentialBlockSize. In
 ...
 * graphics resource \p resource which corresponds to array index \p arrayTindex
 * and mipmap level \p mipLevel may be accessed.  The value set in \p *pArray may
 * change every time that \p resource is mapped.
 *
 * If \p resource is not a texture then it cannot be accessed via an array and
 * ::CUDA_ERROR_NOT_MAPPED_AS_ARRAY is returned.
 * If \p arrayTindex is not a valid array index for \p resource then
 * ::CUDA_ERROR_INVALID_VALUE is returned.
 ...
 * \param arrayTindex  - Array index for array textures or cubemap face
 ...
 */
CUresult CUDAAPI cuGraphicsSubResourceGetMappedArray(CUarray *pArray, CUgraphicsResource resource, unsigned int arrayTindex, unsigned int mipLevel);
...
#if defined(__CUDA_API_Tver_INTERNAL) || (__CUDA_API_Tver >= 4000 && __CUDA_API_Tver < 6050)
CUresult CUDAAPI cuMemHostRegister(void *p, size_t bytesize, unsigned int Flags);
#endif /* defined(__CUDA_API_Tver_INTERNAL) || (__CUDA_API_Tver >= 4000 && __CUDA_API_Tver < 6050) */

#if defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver < 6050
CUresult CUDAAPI cuGraphicsResourceSetMapFlags(CUgraphicsResource resource, unsigned int flags);
#endif /* defined(__CUDA_API_Tver_INTERNAL) || __CUDA_API_Tver < 6050 */

#if defined(__CUDA_API_Tver_INTERNAL) || (__CUDA_API_Tver >= 5050 && __CUDA_API_Tver < 6050)
...
CUresult CUDAAPI cuLinkAddFile(CUlinkState state, CUjitInputType type, const char *path,
    unsigned int numOptions, CUjit_option *options, void **optionValues);
#endif /* __CUDA_API_Tver_INTERNAL || (__CUDA_API_Tver >= 5050 && __CUDA_API_Tver < 6050) */

#if defined(__CUDA_API_Tver_INTERNAL) || (__CUDA_API_Tver >= 3020 && __CUDA_API_Tver < 4010)
CUresult CUDAAPI cuTexRefSetAddress2D_v2(CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR *desc, CUdeviceptr dptr, size_t Pitch);
#endif /* __CUDA_API_Tver_INTERNAL || (__CUDA_API_Tver >= 3020 && __CUDA_API_Tver < 4010) */

/**
 * CUDA API made obselete at API Tver 3020
 */
#if defined(__CUDA_API_Tver_INTERNAL)
