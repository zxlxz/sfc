...
auto Debug::fmt_flt(slice::Slice<char> buf, auto val, Style style) -> str::Str {
...
template auto Debug::fmt_flt(slice::Slice<char>, f32, Style) -> str::Str;
template auto Debug::fmt_flt(slice::Slice<char>, f64, Style) -> str::Str;
