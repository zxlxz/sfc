...
SFC_TEST(parse_i32) {
  ...
  panicking::expect(!Str{"123abc"}.parse<i32>());
...
SFC_TEST(parse_u32) {
  ...
  panicking::expect(!Str{}.parse<u32>());
  panicking::expect(!Str{"abc"}.parse<u32>());
  panicking::expect(!Str{"123abc"}.parse<u32>());
  panicking::expect(!Str{"123.456"}.parse<u32>());

  panicking::expect(!Str{"-123"}.parse<u32>());
  panicking::expect(!Str{"123+"}.parse<u32>());
  panicking::expect(!Str{"123.456"}.parse<u32>());
}
