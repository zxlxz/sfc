...
SFC_TEST(datetime_utc) {
  ...
  sfc::expect_true(dt_utc.year >= 2025);
  sfc::expect_true(dt_utc.month >= 1 && dt_utc.month <= 12);
  sfc::expect_true(dt_utc.day >= 1 && dt_utc.day <= 31);
}
...
SFC_TEST(datetime_local) {
  ...
  sfc::expect_true(dt_local.year >= 2025);
  sfc::expect_true(dt_local.month >= 1 && dt_local.month <= 12);
